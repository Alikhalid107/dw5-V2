...
export class ProductionTimerOverlay {
  ...
  // FIXED: Only check production state — never hide due to hover/mouse position
  if (!this.factory.isProducing && !this.factory.productionSystem?.showProductionComplete) return;
